...
echo "* checkstyle       *"
echo "********************"
cat android/app/build/reports/checkstyle/checkstyle.xml \
    | checkstyle_filter-git diff origin/master_android \
    | saddler report --require saddler/reporter/github --reporter $REPORTER

echo "********************"
echo "* findbugs         *"
echo "********************"
cat android/app/build/reports/findbugs/findbugs.xml \
...
echo "* PMD              *"
echo "********************"
cat android/app/build/reports/pmd/pmd.xml \
...
echo "* PMD-CPD          *"
echo "********************"
cat android/app/build/reports/pmd/cpd.xml \
...
echo "* android lint     *"
echo "********************"
cat android/app/build/outputs/lint-results.xml \
